...
public class FrameTela20 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FrameTela20 frame = new FrameTela20();
	...
	public FrameTela20() {
		...
		lblNewLabel.setBounds(155, 11, 116, 25);
		...
		assistir.setBounds(142, 78, 172, 25);
		...
		voltar.setBounds(317, 197, 89, 23);
