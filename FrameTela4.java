...
public class FrameTela4 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FrameTela4 frame = new FrameTela4();
	...
	public FrameTela4() {
		...
		lblNewLabel.setBounds(161, 34, 107, 19);
		...
		assistir.setBounds(130, 79, 167, 25);
		contentPane.add(assistir);
		
		JButton animacao = new JButton("Animacao");
		...
		animacao.setBounds(130, 141, 167, 25);
		...
		voltar.setBounds(316, 203, 89, 23);
