...
public class FrameTela18 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FrameTela18 frame = new FrameTela18();
	...
	public FrameTela18() {
		...
		lblNewLabel.setBounds(168, 11, 119, 19);
		...
		assistir.setBounds(148, 71, 158, 29);
		...
		voltar.setBounds(312, 201, 89, 23);
