...
public class FrameTela17 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FrameTela17 frame = new FrameTela17();
	...
	public FrameTela17() {
		...
		lblNewLabel.setBounds(154, 11, 138, 19);
		...
		assistir.setBounds(138, 71, 169, 32);
		...
		voltar.setBounds(316, 199, 89, 23);
